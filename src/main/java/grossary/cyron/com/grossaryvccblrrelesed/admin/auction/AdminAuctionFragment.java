...
public class AdminAuctionFragment extends Fragment implements OnItemClickListener<AdminHomeModel.AuctionlistEntity> {

    private ArrayList<AdminHomeModel.AuctionlistEntity> homeList = new ArrayList<>();
    private AdminAuctionListAdapter adapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(adapter.getItemCount()<=0)
        {
            ...
            setData(((AdminHomeActivity)getActivity()).getAdminHomeModel().getAuctionlist(),
                    ((AdminHomeActivity)getActivity()).getAdminHomeModel().getDiscounttype());
        }
    }

    private void setAdapter() {
        adapter = new AdminAuctionListAdapter(getActivity(), this);
    ...
    public List<AdminHomeModel.AuctionlistEntity> getData() {
        return homeList;
    }

    @Override
    public void onItemClick(AdminHomeModel.AuctionlistEntity objstoredetailslist, View view, int position, String type) {
    ...
    public void setData(List<AdminHomeModel.AuctionlistEntity> data, List<AdminHomeModel.DiscounttypeEntity> discounttype) {
        ...
        adapter.setAdapterData(homeList,discounttype);
    }
}
