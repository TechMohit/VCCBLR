...
public class AdminDrawerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final LayoutInflater layoutInflater;
    private final List<AdminDrawerItem> list;
    private final OnItemClickListener onItemClickListener;
    public int selectedPosition = 0;
    private Activity activity;

    public AdminDrawerAdapter(Activity activity, List<AdminDrawerItem> list, OnItemClickListener onItemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_admin_drawer_item, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder,  int position) {
        final AdminDrawerItem object = list.get(position);
