...
public class AdminReconDetailListAdapter extends RecyclerView.Adapter {

    private ArrayList<AdminHomeModel.RecondetailslistEntity> dataSet;
    private Activity activity;
    private OnItemClickListener<AdminHomeModel.RecondetailslistEntity> clickListener;

    public AdminReconDetailListAdapter(Activity activity, OnItemClickListener<AdminHomeModel.RecondetailslistEntity> clickListener) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        final AdminHomeModel.RecondetailslistEntity object = dataSet.get(listPosition);
...
//        ((ImageTypeViewHolder) holder).tvCharge.setText("₹"+ object.getOrderamount());
        Float sum=(Float.valueOf(object.getOrderamount())*Float.valueOf(object.getQty()));
        ((ImageTypeViewHolder) holder).tvAmount.setText("₹" + sum);
...
//        });
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_list_item_recondetal, parent, false);
    ...
    public void setAdapterData(ArrayList<AdminHomeModel.RecondetailslistEntity> sellerList) {
        dataSet = sellerList;
