 ...
 */
public class PriceAddressFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_price_address, container, false);
        ((ProductViewBasedPrice) getActivity()).txtCheckout.setText(MAKE_PAYMENT);
