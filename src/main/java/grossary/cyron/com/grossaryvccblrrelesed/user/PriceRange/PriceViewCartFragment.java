...
import grossary.cyron.com.grossaryvccblrrelesed.user.cart.ViewCartAdapter;
 ...
 */
public class PriceViewCartFragment extends Fragment implements OnItemClickListener<ViewAddtoCartDetailsModel.ListaddtocartviewmodelEntity> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_price_view_cart, container, false);
        initView(view);

        ((ProductViewBasedPrice) getActivity()).txtCheckout.setText(PLACE_YOUR_ORDER);
